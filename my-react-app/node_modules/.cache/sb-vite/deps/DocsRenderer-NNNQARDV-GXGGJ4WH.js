...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-AEVJEBHL.js";
import {
  ActionBar
} from "./chunk-FIQNKXAN.js";
import "./chunk-VIXTMFR3.js";
import {
  ThemeProvider,
  convert,
  ensure,
...
import {
  ...
  require_toKey,
  str
} from "./chunk-BTL4FAGA.js";
import {
  require_Symbol,
  require_isObject,
  require_isObjectLike,
  require_root
} from "./chunk-HEYLYQAC.js";
import {
  P
} from "./chunk-DKZUAT5G.js";
import {
  esm_default
...
import {
  renderElement,
  unmountElement
} from "./chunk-WHSESFIF.js";
import {
  require_global
} from "./chunk-2KSNMO5J.js";
import "./chunk-3RSFAZZN.js";
import "./chunk-6ZMKTG7H.js";
import {
  require_react
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-4TE55DQW.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-RDI5XFCS.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-MS2GM47U.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
telejson/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=DocsRenderer-NNNQARDV-GXGGJ4WH.js.map
