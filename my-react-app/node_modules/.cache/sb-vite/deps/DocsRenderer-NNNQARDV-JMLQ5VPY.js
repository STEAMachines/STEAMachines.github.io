...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-BL5WXR34.js";
import "./chunk-27LGQRTA.js";
import {
  ActionBar
} from "./chunk-4G7AGBP5.js";
import {
  ThemeProvider,
  convert,
  ensure,
...
import {
  ...
  require_toKey,
  str
} from "./chunk-PQ7MZRGA.js";
import {
  require_Symbol,
  require_isObject,
  require_isObjectLike,
  require_root
} from "./chunk-GMQR4P3P.js";
import {
  P
} from "./chunk-P5GDE7V7.js";
import {
  require_core_events
} from "./chunk-G2IFUJHB.js";
import {
  esm_default
} from "./chunk-PXFNQDJD.js";
import {
  renderElement,
  unmountElement
} from "./chunk-U43NL3CH.js";
import {
...
import "./chunk-KGHCRLHL.js";
import "./chunk-3HHPT6M6.js";
import {
  require_react
...
// ../node_modules/.pnpm/@storybook+addon-docs@7.6.2_d45415bd2e73f3e3a9cab2e9f3bfb070/node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs
var import_react2 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/@storybook+blocks@7.6.20_@t_ed408a3031a83fcf7a8c2340014ad477/node_modules/@storybook/blocks/dist/index.mjs
...
function _wrapNativeSuper(t) {
  ...
  return _wrapNativeSuper = function _wrapNativeSuper2(t2) {
    ...
    return Wrapper10.prototype = Object.create(t2.prototype, {
      constructor: {
        value: Wrapper10,
        enumerable: false,
        writable: true,
...
function qe(e2, n2) {
  ...
  return { t: (e3) => a2.test(e3), o: je(function(e3, n3) {
    ...
    return { items: i2.map(function(e4, r3) {
      const o3 = a2.exec(e4)[0].length, c3 = RegExp("^ {1," + o3 + "}", "gm"), l2 = e4.replace(c3, "").replace(a2, ""), s2 = r3 === i2.length - 1, f3 = -1 !== l2.indexOf("\n\n") || s2 && u2;
      u2 = f3;
      const _2 = t2.inline, d2 = t2.list;
      let p2;
      t2.list = true, f3 ? (t2.inline = false, p2 = Se(l2) + "\n\n") : (t2.inline = true, p2 = Se(l2));
      const y2 = n3(p2, t2);
...
function We(r2 = "", t = {}) {
  ...
  const ie2 = [], ue2 = {}, le2 = { 0: { t: [">"], o: Te(s), i: 1, u(e2, n2, r3) {
    const [, t2, o2] = e2[0].replace(f2, "").match(_);
    ...
    const [, t2] = e2[3].match(ae), o2 = RegExp("^" + t2, "gm"), a2 = e2[3].replace(o2, ""), i2 = Q2(H4, a2) ? Ne : Pe, u2 = e2[1].toLowerCase(), l3 = -1 !== c.indexOf(u2), s2 = (l3 ? u2 : e2[1]).trim(), f3 = { attrs: ce2(s2, e2[2]), noInnerParse: l3, tag: s2 };
    if (r3.inAnchor = r3.inAnchor || "a" === u2, l3) f3.text = e2[3];
    else {
      const e3 = r3.inHTML;
      r3.inHTML = true, f3.children = i2(n2, a2, r3), r3.inHTML = e3;
    }
    return r3.inAnchor = false, f3;
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-RJXMACJO.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-LDQKE2EG.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-ZFWTVDEZ.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
telejson/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=DocsRenderer-NNNQARDV-JMLQ5VPY.js.map
